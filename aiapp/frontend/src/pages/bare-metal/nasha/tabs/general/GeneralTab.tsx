  ...
  return (
    <div className="general-tab">
      ...
      <div className="info-grid">
        <div className="info-card"><div className="card-title">{t("general.fields.serviceName")}</div><div className="card-value mono">{nasha.serviceName}</div></div>
        <div className="info-card"><div className="card-title">{t("general.fields.customName")}</div><div className="card-value">{nasha.customName || "-"}</div></div>
        <div className="info-card"><div className="card-title">{t("general.fields.datacenter")}</div><div className="card-value">{nasha.datacenter}</div></div>
        <div className="info-card"><div className="card-title">{t("general.fields.ip")}</div><div className="card-value mono">{nasha.ip}</div></div>
        <div className="info-card"><div className="card-title">{t("general.fields.monitored")}</div><div className="card-value">{nasha.monitored ? "✅ Oui" : "❌ Non"}</div></div>
      </div>
