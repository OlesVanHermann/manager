// ============================================================
// DEDICATED TAB ISOLÉ : InterventionsTab
// ============================================================
  ...
  useEffect(() => {
    const load = async () => {
      try {
        ...
        const data = await Promise.all(ids.slice(0, 50).map((id) => interventionsService.getIntervention(serviceName, id)));
  ...
  return (
    <div className="interventions-tab">
      <div className="tab-header">
        ...
        <p className="tab-description">{t("interventions.description")}</p>
      </div>
