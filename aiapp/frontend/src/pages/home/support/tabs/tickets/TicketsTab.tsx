...
export function TicketsTab() {
  ...
  // ---------- RENDER ----------
  if (loading) {
    return <div className="tickets-tab"><div className="tickets-loading-state"><div className="tickets-spinner"></div><p>{t('tickets.loading')}</p></div></div>;
  }

  if (error) {
    return <div className="tickets-tab"><div className="tickets-error-banner"><span>{error}</span><button onClick={loadTickets}>{tCommon('actions.refresh')}</button></div></div>;
  }
