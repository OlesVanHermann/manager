...
const TicketIcon = () => (
  <svg className="create-option-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
...
const ExternalIcon = () => (
  <svg className="create-link-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="14" height="14">
...
export function CreateTab() {
  ...
  return (
    <div className="create-container">
      ...
      <div className="create-quick-links">
