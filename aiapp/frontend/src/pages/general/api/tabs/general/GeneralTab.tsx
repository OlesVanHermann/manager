...
const BookIcon = () => (
  <svg className="general-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
const GithubIcon = () => (
  <svg className="general-icon" viewBox="0 0 24 24" fill="currentColor">
...
const ExternalLinkIcon = () => (
  <svg className="general-link-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
  ...
  return (
    <div className="general-container">
      ...
      {categories.map((category) => {
        ...
        return (
          <div key={category.key} className="general-section">
            <h3 className="general-section-title">{category.label}</h3>
            <div className="general-links-grid">
              {links.map((link, index) => (
                <a
                  ...
                  className="general-link-card"
                >
                  <div className="general-link-icon-wrapper">{link.icon}</div>
                  <div className="general-link-content">
                    <div className="general-link-title">
                      {link.title}
                      <ExternalLinkIcon />
                    </div>
                    <div className="general-link-description">{link.description}</div>
                  </div>
                </a>
              ))}
            </div>
