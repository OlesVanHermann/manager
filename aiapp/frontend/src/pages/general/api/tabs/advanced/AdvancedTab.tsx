...
export function AdvancedTab() {
  ...
  // ---------- RENDER ----------
  return (
    <div className="api-advanced-tab">
      {/* Session Info */}
      <div className="api-advanced-section">
        <h3>{t('advanced.session.title')}</h3>
        <div className="api-advanced-card">
          <div className="api-advanced-grid">
            <div className="api-advanced-field">
              <label>{t('advanced.session.authenticated')}</label>
              <span className={credentials ? "api-advanced-badge advanced-badge-success" : "api-advanced-badge advanced-badge-error"}>
          ...
          <button onClick={clearSession} className="api-advanced-btn advanced-btn-danger advanced-btn-sm">{t('advanced.session.clear')}</button>
        </div>
      </div>
          ...
          {user ? (
            <div className="api-advanced-grid">
              ...
              <div className="api-advanced-field">
                ...
                <span className={user.isTrusted ? "api-advanced-badge advanced-badge-success" : "api-advanced-badge advanced-badge-neutral"}>
            ...
            <p className="api-advanced-empty">{t('advanced.user.empty')}</p>
          )}
        </div>
      </div>
