...
import { generalTabService, type LineServiceInfos } from './GeneralTab.service';
...
export function GeneralTab({
  ...
  const { t } = useTranslation('web-cloud/voip/lines/general');
  ...
  const handleSave = async () => {
    try {
      setSaving(true);
      await generalTabService.updateLine(billingAccount, serviceName, { description });
