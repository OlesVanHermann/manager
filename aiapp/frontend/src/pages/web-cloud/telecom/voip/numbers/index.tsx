...
import { SchedulerTab } from './tabs/scheduler/SchedulerTab';
...
import { DdiTab } from './tabs/ddi/DdiTab';
import { SoundsTab } from './tabs/sounds/SoundsTab';
import { StatsTab } from './tabs/stats/StatsTab';
import { SviTab } from './tabs/svi/SviTab';
...
export default function NumberPage({
  ...
  const { t } = useTranslation('web-cloud/telecom/voip/numbers/index');
