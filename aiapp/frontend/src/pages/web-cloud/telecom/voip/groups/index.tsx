...
import { PortabilityTab } from './tabs/portability/PortabilityTab';
import { BillingTab } from './tabs/billing/BillingTab';
import { RepaymentsTab } from './tabs/repayments/RepaymentsTab';
...
export default function GroupPage({ billingAccount: propBillingAccount }: GroupPageProps) {
  const { t } = useTranslation('web-cloud/telecom/voip/groups/index');
