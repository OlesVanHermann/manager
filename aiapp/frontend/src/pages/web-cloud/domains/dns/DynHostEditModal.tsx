// ============================================================
// MODAL: DynHostEditModal - Modifier un enregistrement DynHost
// Basé sur target SVG modal-dynhost-edit.svg
// ============================================================
...
export function DynHostEditModal({ zoneName, record, onClose, onSuccess }: Props) {
  ...
  const handleSubmit = async () => {
    ...
    setError(null);
    try {
      await dynHostService.updateRecord(zoneName, record.id, {
      ...
      <div className="dom-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="dom-modal-content">
          ...
          <div className="dom-modal-required-note">
            * {t("modals.edit.requiredFields")}
          </div>

          <div className="dom-modal-form">
            <div className="dom-modal-field">
              <label>{t("modals.edit.subDomain")}</label>
...
export default DynHostEditModal;
