// ============================================================
// MODAL: GlueDeleteModal - Supprimer un enregistrement GLUE
// Basé sur target SVG modal-glue-delete.svg
// ============================================================
...
export function GlueDeleteModal({ domain, record, onClose, onSuccess }: Props) {
  ...
  const handleDelete = async () => {
    ...
    setError(null);
    try {
      await glueService.deleteGlue(domain, record.host);
      onSuccess();
      onClose();
    } catch (err) {
      setError(String(err));
      ...
      <div className="dom-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="dom-modal-content dom-modal-content-center">
          ...
          <div className="dom-modal-record-preview">
            <span className="dom-modal-record-name">{record.host}</span>
            <span className="dom-modal-record-target">→ {record.ips.join(", ")}</span>
          </div>
...
export default GlueDeleteModal;
