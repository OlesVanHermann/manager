// ============================================================
// EMAIL DOMAIN TAB: MAILING LISTS (style Hosting)
// ============================================================
...
export function MailingListsTab({ domain }: Props) {
  ...
  return (
    <div className="mailinglists-tab">
      <div className="tab-header">
        <div>
          <h3>{t("mailinglists.title")}</h3>
          <p className="tab-description">{t("mailinglists.description")}</p>
        </div>
        <span className="records-count">{lists.length}</span>
      </div>
      ...
      {lists.length === 0 ? (
        ...
        <div className="mailinglist-cards">
          {lists.map(l => (
            <div key={l.id} className="mailinglist-card">
              <div className="mailinglist-icon">📧</div>
              <h4>{l.name}@{domain}</h4>
              <div className="mailinglist-stats">
