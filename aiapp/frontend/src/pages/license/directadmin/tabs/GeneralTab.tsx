...
/** Affiche les informations générales de la licence DirectAdmin. */
  ...
  return (
    <div className="directadmin-general-tab">
      <div className="directadmin-general-toolbar">
        <h2>{t("directadmin.general.title")}</h2>
      ...
      <div className="directadmin-general-info-card">
        <div className="directadmin-general-info-grid">
          ...
          <div className="directadmin-general-info-item">
            <span className="directadmin-general-info-label">{t("directadmin.general.fields.os")}</span>
          ...
          <div className="directadmin-general-info-item">
            ...
            <span className="directadmin-general-info-value">
