// ============================================================
// DIRECTADMIN LICENSE PAGE - Page principale isolée
// ============================================================
...
import { getDirectAdminLicense } from "./tabs/general/GeneralTab.service";
...
export default function DirectAdminLicensePage() {
  ...
  const loadLicense = async () => {
    if (!licenseId) return;
    try { setLoading(true); const data = await getDirectAdminLicense(licenseId); setLicense(data); } finally { setLoading(false); }
  };
  ...
  return (
    <div style={styles.page}>
      <div style={styles.header}>
        <h1 style={styles.title}>DirectAdmin - {licenseId}</h1>
