// ============================================================
// CPANEL LICENSE PAGE - Page principale isolée
// ============================================================
...
import { getCpanelLicense } from "./tabs/general/GeneralTab.service";
...
export default function CpanelLicensePage() {
  ...
  const loadLicense = async () => {
    if (!licenseId) return;
    try { setLoading(true); const data = await getCpanelLicense(licenseId); setLicense(data); } finally { setLoading(false); }
  };
  ...
  return (
    <div style={styles.page}>
      <div style={styles.header}>
        <h1 style={styles.title}>cPanel - {licenseId}</h1>
