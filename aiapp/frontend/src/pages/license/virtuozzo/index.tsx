...
import { getVirtuozzoLicense } from "./tabs/general/GeneralTab.service";
...
export default function VirtuozzoLicensePage() {
  ...
  const loadLicense = async () => {
    if (!licenseId) return;
    try { setLoading(true); const data = await getVirtuozzoLicense(licenseId); setLicense(data); } finally { setLoading(false); }
  };
