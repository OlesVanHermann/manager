...
import { getSqlServerLicense } from "./tabs/general/GeneralTab.service";
...
export default function SqlServerLicensePage() {
  ...
  const loadLicense = async () => {
    if (!licenseId) return;
    try { setLoading(true); const data = await getSqlServerLicense(licenseId); setLicense(data); } finally { setLoading(false); }
  };
