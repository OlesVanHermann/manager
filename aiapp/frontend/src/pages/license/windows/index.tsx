// ============================================================
// WINDOWS LICENSE PAGE - Page principale isolée
// ============================================================
...
import { getWindowsLicense } from "./tabs/general/GeneralTab.service";
...
export default function WindowsLicensePage() {
  ...
  const loadLicense = async () => {
    if (!licenseId) return;
    try { setLoading(true); const data = await getWindowsLicense(licenseId); setLicense(data); } finally { setLoading(false); }
  };
  ...
  return (
    <div style={styles.page}>
      <div style={styles.header}>
        <h1 style={styles.title}>Windows - {licenseId}</h1>
