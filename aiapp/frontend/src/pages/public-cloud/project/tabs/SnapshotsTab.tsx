...
import { cloudService, CloudSnapshot } from "../../../../services/cloud.service";
...
export function SnapshotsTab({ projectId }: Props) {
  ...
  useEffect(() => {
    const load = async () => {
      try { setLoading(true); const data = await cloudService.listSnapshots(projectId); setSnapshots(data); }
