  ...
  return (
    <div className="general-tab">
      ...
      <div className="general-info-grid">
        ...
        <div className="general-info-card">
          <div className="general-card-title">{t("general.fields.model")}</div>
        ...
        <div className="general-info-card">
          <div className="general-card-title">{t("general.fields.ip")}</div>
      ...
      <div className="general-info-section">
        ...
        <p className="general-info-description">{t("general.connection.description")}</p>
      ...
      <div className="general-info-section" style={{ marginTop: "var(--space-4)" }}>
        ...
        <p className="general-info-description">{t("general.documentation.description")}</p>
