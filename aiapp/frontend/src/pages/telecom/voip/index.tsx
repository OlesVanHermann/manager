...
import { telecomService, TelephonyBillingAccount } from "../../../services/telecom.service";
...
export default function VoipPage() {
  ...
  const loadAccounts = useCallback(async () => {
    try {
      setLoading(true);
      const names = await telecomService.listBillingAccounts();
      ...
      for (const name of names) {
        try {
          const details = await telecomService.getBillingAccount(name);
