...
tar -cf /home/ubuntu/old_manager.bare-metal.nasha.tar $EXCLUDES \
    ...
    ./packages/manager/modules/bm-server-components \
    ovh-api-services/src/api/vrack/nasha \
    ovh-api-services/src/api/order/dedicated/nasha
...
tar -cf /home/ubuntu/old_manager.home.billing.tar $EXCLUDES \
    ...
    ovh-api-services/src/api/me/billing
...
tar -cf /home/ubuntu/old_manager.network.cdn.tar $EXCLUDES \
    ./packages/manager/apps/dedicated/client/app/cdn \
    ovh-api-services/src/api/cdn
...
tar -cf /home/ubuntu/old_manager.private-cloud.core.tar $EXCLUDES \
    ...
    ./packages/manager/apps/dedicated/client/app/components/dedicated-cloud \
...
tar -cf /home/ubuntu/old_manager.private-cloud.veeam.tar $EXCLUDES \
    ...
    ovh-api-services/src/api/veeamEnterprise
...
tar -cf /home/ubuntu/old_manager.web-cloud.access.pack-xdsl.tar $EXCLUDES \
    ...
    ovh-api-services/src/api/pack \
    ovh-api-services/src/api/xdsl \
    ovh-api-services/src/api/connectivity
...
tar -cf /home/ubuntu/old_manager.web-cloud.emails.email-domain.tar $EXCLUDES \
    ...
    ./packages/manager/modules/web-universe-components \
    ovh-api-services/src/api/email/domain
...
tar -cf /home/ubuntu/old_manager.web-cloud.telecom.carrier-sip.tar $EXCLUDES \
    ...
    ./packages/manager/modules/telecom-universe-components \
    ovh-api-services/src/api/telephony/carrierSip
...
tar -cf /home/ubuntu/old_manager.web-cloud.telecom.fax.tar $EXCLUDES \
    ...
    ./packages/manager/apps/telecom/src/app/telecom/telephony/fax \
    ./packages/manager/apps/telecom/src/app/telecom/telephony/service/fax \
    ./packages/manager/apps/telecom/src/app/telecom/telephony/line/fax \
    ./packages/manager/apps/telecom/src/components/telecom/telephony/group/fax \
    ./packages/manager/apps/telecom/src/app/telecom/pack/slots/voipEcoFax \
    ./packages/manager/apps/telecom/src/app/telecom/telephony/billingAccount/convertToVoicefax \
    ./packages/manager/modules/telecom-universe-components \
    ovh-api-services/src/api/freeFax \
    ovh-api-services/src/api/telephony/fax
